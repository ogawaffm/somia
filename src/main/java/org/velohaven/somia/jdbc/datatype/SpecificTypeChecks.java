...
public interface SpecificTypeChecks {
     ...
     * @return true if the type is create this type
     */
    boolean isChar();
    ...
    /**
     * Returns whether the type is ARRAY (collectin type) as defined according to the sql standard.
    ...
    /**
     * Returns whether the type is (a user-definied) row type as defined according to the sql standard.
